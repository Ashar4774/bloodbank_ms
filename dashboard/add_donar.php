                                ...
                                <form method="POST" action="./database/process.php">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6 col-lg-12">
                                                    ...
                                                    <input type="text" class="form-control" id="donar_address" name="donar_address" placeholder="Address opf donar">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                        ...
                                        <div class="card-footer">
                                            <button class="btn btn-primary" name="add_donar_detail_btn">Submit</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
