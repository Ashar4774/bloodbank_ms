                            ...
                            <div class="col-12 col-md-6 col-lg-11 mx-auto">
                                <form method="POST" action="./database/process.php">
                                    <div class="card">
                                        ...
                                        // Edit
                                        if (isset($_GET['edit_blood_detail'])) {
                                            $edit_blood_detail = $_GET['edit_blood_detail'];
                                            $query = "SELECT * FROM `blood_types` WHERE `id` = $edit_blood_detail";
                                        ...
                                        ?>
                                            ...
                                            <div class="card-body">
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <input type="hidden" name="blood_detail_id" value="<?php echo $row['id'] ?>">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <select id="org_id" class="form-control" name="org_id" required>
                                                            ...
                                                            $results_org = $conn->query($query_org);
                                                            while ($row_org = $results_org->fetch_assoc()) {
                                                                $selected_org = ($row['org_id'] == $row_org['id']) ? 'selected' : '';
                                                            ?>
                                                                <option value="<?php echo $row_org['id'] ?>" <?php echo $selected_org; ?>><?php echo $row_org['name'] ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-footer">
                                                <button class="btn btn-primary" name="update_blood_detail_btn">Submit</button>
                                            </div>
                                        <?php } ?>
                                    </div>
                                </form>
